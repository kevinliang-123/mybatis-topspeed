package com.tengjie.common.config;
...
public class Global implements Serializable{
	...
	/**
	 * 获取应用部署所在的位置，如指向方式，这里就是tomcat指向的地址
	 */
	...
	private static Object userUtils;
   public static Object findUserUtils(){ 
	   if(userUtils==null){
		   try { 
			userUtils=Class.forName(Global.getConfig("userUtils").trim()).newInstance();
