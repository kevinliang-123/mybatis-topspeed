...
implements ClassGenerator
{
    ...
    private String getClassName(final ClassLoader loader) {
        ...
        if(nameCache==null)return null;
        if(namePrefix==null&&key==null&&source.name.equals("com.tengjie.cglib.cust.BeanGenerator")) {
        	return null;
        }
    ...
    private Set getClassNameCache(ClassLoader loader) {
    	if(source.cache.get(loader)==null)return null;
